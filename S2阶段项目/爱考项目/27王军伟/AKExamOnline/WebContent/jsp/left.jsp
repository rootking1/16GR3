...
<script type="text/javascript">
	...
	outlookbar.additem('教师信息管理', t, 'developing.jsp');
	outlookbar.additem('班级信息管理', t, 'developing.jsp');
	outlookbar.additem('学生信息管理', t, 'developing.jsp');
	outlookbar.additem('题库管理', t, 'questionsManage.jsp');
	outlookbar.additem('试卷管理', t, 'paperManage.jsp');
	outlookbar.additem('成绩管理', t, 'developing.jsp');
	outlookbar.additem('新闻中心', t, 'developing.jsp');
